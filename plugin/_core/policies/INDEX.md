...
| `assumption-verification.md` | verbatim+footer | Cycle-recurring engagements; `/comp resume` after long gap; before debugging deployed integrations || `cost-discipline.md` | verbatim | All paid-API dispatch (Perplexity, market-data); referenced by `$ASSET_ROOT/_core/primitives/budget-check.md` |
...
| `review-dispatch-budget.md` | verbatim | Council dispatch sizing; multi-perspective audits inside any mode || `secret-handling-discipline.md` | verbatim+footer | Any shell consumption of fetched secrets (MCP wrappers, scripts) |
